                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('img/media-image-size.png') }}')">
                                            ...
                                            <div class="image-input-wrapper " style="background-image: url({{ url('images/malie/news/'.$objs->image) }}); width:380px; height:200px"></div>
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" aria-label="Select example" name="type">
                                            <option value="0" @if( $objs->type == 0)
                                                selected='selected'
                                                @endif>ข่าวสารทั่วไป</option>
                                            <option value="1" @if( $objs->type == 1)
                                                selected='selected'
                                                @endif>DEALS & PACKAGE</option>
                                        </select>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <textarea name="detail" class="summernote" id="kt_docs_ckeditor_classic" >{{ $objs->detail }}</textarea>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <textarea name="detail_en" class="summernote" id="kt_docs_ckeditor_classic" >{{ $objs->detail_en }}</textarea>
