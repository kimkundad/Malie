                    ...
                    <form id="kt_account_profile_details_form" class="form" method="POST" action="{{$url}}" enctype="multipart/form-data">
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">หมวดหมู่ข่าวสาร</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" aria-label="Select example" name="type">
                                            <option value="0">ข่าวสารทั่วไป</option>
                                            <option value="1">DEALS & PACKAGE</option>
                                        </select>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">ชื่อกิจกรรม & ประชาสัมพันธ์ไทย</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        @if ($errors->has('title'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากรอกชื่อกิจกรรม & ประชาสัมพันธ์ไทย</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">ชื่อกิจกรรม & ประชาสัมพันธ์ Eng</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        @if ($errors->has('title_en'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากรอกชื่อกิจกรรม & ประชาสัมพันธ์ Eng </div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รายละเอียดแบบย่อ ไทย</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รายละเอียดแบบย่อ Eng</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-2 col-form-label required fw-semibold fs-6">รายละเอียดไทย</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <textarea name="detail" class="summernote" id="kt_docs_ckeditor_classic" ><h3>กรอกรายละเอียด...</h3>{{old('detail') ? old('detail') : ''}}</textarea>
                                        @if ($errors->has('detail'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากรอกรายละเอียดไทย</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-2 col-form-label required fw-semibold fs-6">รายละเอียดEng</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <textarea name="detail_en" class="summernote" id="kt_docs_ckeditor_classic" ><h3>กรอกรายละเอียด...</h3>{{old('detail_en') ? old('detail_en') : ''}}</textarea>
                                        @if ($errors->has('detail_en'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากรอกรายละเอียดEng</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
