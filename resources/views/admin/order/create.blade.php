...
<style>
    ...
    .special-date {
  background-color: yellow; /* Custom styling for special dates */
}
    </style>
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="first_name" class="form-control form-control-lg form-control-solid" placeholder="น้องมิลค์" value="{{old('first_name') ? old('first_name') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="last_name" class="form-control form-control-lg form-control-solid" placeholder="ขยันดีจัง" value="{{old('last_name') ? old('last_name') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="095-586-xxxx" value="{{old('phone') ? old('phone') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="email" class="form-control form-control-lg form-control-solid" placeholder="milk@gmail.com" value="{{old('email') ? old('email') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            <input class="form-control form-control-solid ps-12" name="arrive" placeholder="วันที่จองที่พัก" id="kt_datepicker_1" />
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            <input class="form-control form-control-solid ps-12" name="departure" placeholder="วันที่จองที่พัก" id="kt_datepicker_2" />
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="adults" class="form-control form-control-lg form-control-solid" placeholder="16 คน" value="{{old('adults') ? old('adults') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea class="form-control form-control-lg form-control-solid" id="textareaAutosize" placeholder="รายละเอียดแบบย่อ..." rows="3" name="note" >{{old('note') ? old('note') : ''}} </textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
...
const specialDates = ["2024-02-14", "2024-02-21", "2024-02-28"];

flatpickr("#kt_datepicker_2", {
    // Specify dates to be highlighted
    disable: specialDates
