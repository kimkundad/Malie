            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/review/create') }}" class="btn btn-sm fw-bold btn-primary" >
                                        ...
                                        <tr id="{{$item->id}}">
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ url('images/malie/review/'.$item->image) }}" alt="">
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/review/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_review/'.$item->id) }}"  onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
