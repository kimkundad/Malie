@extends('layouts.template2')
    ...
    @section('title')
    ติดต่อเรา ที่พักพูลวิลล่า Malie เกาะสมุย (Villa Malie Koh Samui)
    @stop
                    ...
                    <div class="col-md-6 col-lg-5">
                        ...
                        <div class="text">
                            <h2>@if(session()->get('locale') == 'en')
                                ...
                                @endif</h2>
                                    @if(session()->get('locale') == 'en')
                                    <p>Convenient and fast booking with support from Villa Malie. We are
                                        ready to answer any questions which customers have either before or
                                        after your stay.  Please do not hestiate to contact via the following
                                        channels.</p>
                                    @else
                                    <p>จองสะดวกและรวดเร็วด้วยการสนับสนุนจากวิลล่ามาลี เราคือ
                                        พร้อมตอบทุกคำถามที่ลูกค้ามีมาก่อนหรือ
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="check_availability-field">
                                            <select class="field-text" id="type" name="type" style="height: 40px;">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea cols="30" rows="10" name="message"  class="field-textarea" id='massage' placeholder="Please write to us with any questions, we are here to help."></textarea>
                                    </div>
                                    <div class="col-sm-6">
