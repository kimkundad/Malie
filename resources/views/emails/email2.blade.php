								...
								<tbody>
									...
									<tr>
										<td align="center" valign="center" style="font-size: 13px; text-align:center; padding: 0 10px 10px 10px; font-weight: 500; color: #A1A5B7; font-family:Arial,Helvetica,sans-serif">
											...
											<p style="margin-bottom:2px; <!DOCTYPE html>
<html lang="en">
	<head>
		<title>Welcome to Villa Malie</title>
		<meta charset="utf-8" />
							...
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" height="auto" style="border-collapse:collapse">
								<tbody>
									...
									<tr>
										<td align="center" valign="center" style="font-size: 13px; text-align:center; padding: 0 10px 10px 10px; font-weight: 500; color: #A1A5B7; font-family:Arial,Helvetica,sans-serif">
											<p style="color:#181C32; font-size: 16px; font-weight: 600; margin-bottom:9px">It’s all about customers!</p>
											<p style="margin-bottom:2px; margin-top: 0px;">Call our customer care number: {{ get_phone() }}</p>
											<p style="margin-bottom:4px; margin-top: 0px;">You may reach us at
											<a href="mailto:{{ get_email() }}" rel="noopener" target="_blank" style="font-weight: 600; margin-top: 0px;">{{ get_email() }}</a>.</p>
											<p style="margin-top: 0px;">We serve Mon-Sun, 9AM-18AM</p>
										</td>
									</tr>
									<tr>
	...
	<!--end::Body-->
</html>">Call our customer care number: {{ get_phone() }}</p>
