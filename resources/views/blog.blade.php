@extends('layouts.template2')
    ...
    @section('title')
    ข่าวสารของที่พักพูลวิลล่า Malie เกาะสมุย (Villa Malie Kor Samui)
    @stop
                        ...
                        <div class="blog-content">
                            ...
                            <article class="post">
                                ...
                                <div class="entry-media">
                                    <a href="#" class="post-thumbnail hover-zoom"><img src="{{ url('home/images/blog/img-2.jpg') }}" alt=""></a>
                            ...
                            <article class="post">
                                ...
                                <div class="entry-media">
                                    ...
                                    <div class="post-slider owl-single">
                                        <img src="{{ url('home/images/blog/img-2.jpg') }}" alt="">
                                        <img src="{{ url('home/images/blog/img-2.jpg') }}" alt="">
                                    </div>
                            ...
                            <article class="post">
                                ...
                                <div class="entry-media has-format">
                                    ...
                                    <a href="#" class="post-thumbnail"><img src="{{ url('home/images/blog/img-2.jpg') }}" alt=""></a>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget widget_deal">
                                ...
                                <div class="widget-deal owl-single">
                                    ...
                                    <div class="item">
                                        <div class="img">
                                            <img src="{{ url('home/images/hotel/img-1.jpg') }}" alt="">
                                        </div>
                                        <div class="text">
                            ...
                            <div class="widget widget_recent_entries has_thumbnail">        
                                ...
                                <ul>
                                    <li>
                                        <div class="img">
                                            <a href="#"><img src="{{ url('home/images/blog/thumbnail/img-2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="text">
